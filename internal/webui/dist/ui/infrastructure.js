...
function Review({ value, onConfirm, onClose, busy }) {
    ...
    const lifecycleInstance = value.instance;
    const lifecycleDatabases = value.databases;
    const lifecycleDatabase = value.database;
    const lifecycleDatabaseInstance = value.instance;
    ...
    return React.createElement(Modal, { title: "Revisar cambio de infraestructura", subtitle: "Solo se aplicar\u00E1 cuando confirmes", onClose: onClose, wide: true },
        ...
        lifecycleInstance && lifecycleAction === 'archive-instance' && React.createElement(React.Fragment, null,
            React.createElement(Alert, null,
                React.createElement("strong", null, "Se retirar\u00E1 solo del cat\u00E1logo activo."),
                " Los recursos Docker, credenciales, carpetas, vol\u00FAmenes e im\u00E1genes se conservar\u00E1n."),
            React.createElement("section", { className: "panel" },
                React.createElement("h3", null,
                    "Archivar ",
                    lifecycleInstance.name),
                React.createElement("p", { className: "mono" },
                    lifecycleInstance.id,
                    " \u00B7 ",
                    lifecycleInstance.requestedImage),
                React.createElement("p", null,
                    React.createElement("strong", null, "Datos:"),
                    " ",
                    lifecycleInstance.location),
                React.createElement("p", null,
                    React.createElement("strong", null, "Bases conservadas:"),
                    " ",
                    lifecycleDatabases?.length || 0),
                preserved && React.createElement("ul", null, preserved.map(item => React.createElement("li", { key: item }, item))))),
        lifecycleInstance && lifecycleAction === 'restore-instance' && React.createElement(React.Fragment, null,
            React.createElement(Alert, null,
                React.createElement("strong", null, "Volver\u00E1 al cat\u00E1logo activo sin iniciar el runtime."),
                " No se modificar\u00E1n contenedores ni datos."),
            React.createElement("section", { className: "panel" },
                React.createElement("h3", null,
                    "Restaurar ",
                    lifecycleInstance.name),
                ...
                React.createElement("p", null,
                    ...
                    lifecycleInstance.location),
                React.createElement("p", null,
                    React.createElement("strong", null, "Bases restauradas:"),
                    " ",
                    lifecycleDatabases?.length || 0))),
        lifecycleDatabase && lifecycleAction === 'archive-database' && React.createElement(React.Fragment, null,
            React.createElement(Alert, null,
                React.createElement("strong", null, "Archivo reversible."),
                " La base f\u00EDsica, su usuario y credencial se conservar\u00E1n."),
            React.createElement("section", { className: "panel" },
                React.createElement("h3", null,
                    "Archivar ",
                    lifecycleDatabase.name),
                React.createElement("p", { className: "mono" },
                    lifecycleDatabase.id,
                    " \u00B7 ",
                    lifecycleDatabase.username),
                React.createElement("p", null,
                    "Instancia: ",
                    lifecycleDatabaseInstance?.name,
                    " \u00B7 Datos: ",
                    lifecycleDatabaseInstance?.location))),
        lifecycleDatabase && lifecycleAction === 'restore-database' && React.createElement(React.Fragment, null,
            React.createElement(Alert, null, "La metadata volver\u00E1 al cat\u00E1logo activo sin iniciar el motor ni modificar datos."),
            React.createElement("section", { className: "panel" },
                React.createElement("h3", null,
                    "Restaurar ",
                    lifecycleDatabase.name),
                React.createElement("p", { className: "mono" },
                    ...
                    " \u00B7 ",
                    lifecycleDatabase.username))),
        lifecycleDatabase && lifecycleAction === 'purge-database' && React.createElement(React.Fragment, null,
            React.createElement(Alert, { error: true },
                React.createElement("strong", null, "Operaci\u00F3n irreversible."),
                " Se eliminar\u00E1n f\u00EDsicamente la base y su cuenta limitada. No se tocar\u00E1n bases hermanas."),
            React.createElement("section", { className: "panel" },
                React.createElement("h3", null,
                    "Purgar ",
                    lifecycleDatabase.name),
                ...
                React.createElement("p", null,
                    "Modalidad: ",
                    value.mode === 'backup-purge' ? 'Crear backup verificado y después purgar' : 'Purgar sin backup'),
                React.createElement("p", null,
                    "Instancia: ",
                    lifecycleDatabaseInstance?.name,
                    " \u00B7 ",
                    lifecycleDatabaseInstance?.engine))),
...
export function InfrastructureView({ catalog, status, notify }) {
    ...
    const [create, setCreate] = useState(false), [dbFor, setDbFor] = useState(null), [connection, setConnection] = useState(null), [link, setLink] = useState(null), [dbLifecycle, setDbLifecycle] = useState(null), [logs, setLogs] = useState(null), [backup, setBackup] = useState(null);
    ...
    return React.createElement(React.Fragment, null,
        ...
        data && !data.instances.length && !data.archivedInstances?.length && React.createElement("section", { className: "empty" },
        ...
        data?.instances.map(r => React.createElement("section", { className: "panel infra-instance", key: r.uid },
            ...
            React.createElement("div", { className: "button-row" },
                ...
                React.createElement("button", { className: "danger", title: r.consumers.length ? 'Desvincula todos los consumidores antes de archivar.' : ['running', 'restarting', 'paused', 'starting'].includes(r.execution) ? 'Detén la instancia antes de archivar.' : 'Conserva runtime y datos; retira solo del catálogo activo.', disabled: !canMutate || r.consumers.length > 0 || ['running', 'restarting', 'paused', 'starting'].includes(r.execution), onClick: () => { void api('/infra/archive-preview', { instance: r.id }).then(value => setReview({ value, body: { action: 'archive-instance', instance: r.id } })).catch(e => setError(message(e))); } }, "Archivar del cat\u00E1logo")),
                    ...
                    React.createElement("tbody", null, r.databases.map(db => React.createElement("tr", { key: db.id },
                        ...
                        React.createElement("td", null,
                            React.createElement("div", { className: "button-row" },
                                ...
                                React.createElement("button", { className: "danger", disabled: !canMutate, onClick: () => setDbLifecycle({ db, engine: r.engine }) }, "Gestionar ciclo de vida")))))))),
            !!data?.archivedDatabases?.some(db => db.instanceUid === r.uid) && React.createElement("div", { className: "archived-databases" },
                React.createElement("h3", null, "Bases archivadas"),
                React.createElement("div", { className: "table-wrap" },
                    React.createElement("table", null,
                        React.createElement("thead", null,
                            React.createElement("tr", null,
                                ...
                                React.createElement("th", null, "Usuario"),
                                React.createElement("th", null, "Archivada"),
                                React.createElement("th", null, "Acci\u00F3n"))),
                        React.createElement("tbody", null, data.archivedDatabases.filter(db => db.instanceUid === r.uid).map(db => React.createElement("tr", { key: db.id },
                            React.createElement("td", null,
                                React.createElement("strong", null, db.name),
                                React.createElement("br", null),
                                React.createElement("small", { className: "mono" }, db.id)),
                            React.createElement("td", { className: "mono" }, db.username),
                            React.createElement("td", null, new Date(db.archivedAt).toLocaleString()),
                            React.createElement("td", null,
                                React.createElement("button", { className: "primary", disabled: !canMutate, onClick: () => { void api('/infra/restore-database-preview', { database: db.id }).then(value => setReview({ value, body: { action: 'restore-database', database: db.id } })).catch(e => setError(message(e))); } }, "Restaurar base")))))))),
        ...
        !!data?.archivedInstances?.length && React.createElement("section", { className: "archived-instances" },
            React.createElement("div", { className: "section-heading compact" },
                React.createElement("div", null,
                    React.createElement("span", { className: "eyebrow" }, "FUERA DEL CAT\u00C1LOGO ACTIVO"),
                    React.createElement("h2", null, "Instancias archivadas"),
                    React.createElement("p", null, "Sus identidades, recursos y rutas siguen reservados. Restaurar no inicia el runtime."))),
            data.archivedInstances?.map(r => React.createElement("section", { className: "panel infra-instance", key: r.uid },
                React.createElement("div", { className: "panel-heading" },
                    React.createElement(Icon, { name: "cube" }),
                    React.createElement("div", null,
                ...
                React.createElement("div", { className: "infra-facts" },
                    React.createElement("div", null,
                        React.createElement("span", null, "Persistencia conservada"),
                        React.createElement("code", null, r.location)),
                    React.createElement("div", null,
                        React.createElement("span", null, "Bases conservadas"),
                        React.createElement("strong", null, r.databaseCount)),
                    React.createElement("div", null,
                        React.createElement("span", null, "Archivada"),
                        React.createElement("time", null, new Date(r.archivedAt).toLocaleString()))),
                React.createElement("div", { className: "button-row" },
                    React.createElement("button", { className: "primary", disabled: !canMutate, onClick: () => { void api('/infra/restore-instance-preview', { instance: r.id }).then(value => setReview({ value, body: { action: 'restore-instance', instance: r.id } })).catch(e => setError(message(e))); } }, "Restaurar en el cat\u00E1logo"))))),
        create && data &&
            React.createElement(CreateInstance, { data: data, onClose: () => setCreate(false), onReview: (body, value) => { setCreate(false); setReview({ body: { ...body, action: 'create' }, value }); } }),
        dbFor &&
            React.createElement(CreateDatabase, { instance: dbFor, onClose: () => setDbFor(null), onSubmit: body => { setDbFor(null); void action(body); } }),
        connection &&
            React.createElement(ConnectionDialog, { database: connection, onClose: () => setConnection(null) }),
        link &&
            React.createElement(BindingDialog, { database: link, engine: data?.instances.find(r => r.uid === link.instanceUid)?.engine || 'postgres', stacks: catalog.stacks, onClose: () => setLink(null), onReview: (body, value) => { setLink(null); setReview({ value, body: { ...body, action: 'bind' } }); } }),
        dbLifecycle && React.createElement(DatabaseLifecycleDialog, { ...dbLifecycle, onClose: () => setDbLifecycle(null), onReview: (body, value) => { setDbLifecycle(null); setReview({ body, value }); } }),
...
function DatabaseLifecycleDialog({ db, engine, onClose, onReview }) {
    const [mode, setMode] = useState('archive'), [directory, setDirectory] = useState(''), [typedId, setTypedId] = useState(''), [acknowledge, setAcknowledge] = useState(false), [busy, setBusy] = useState(false), [error, setError] = useState('');
    const destructiveUnavailable = engine === 'redis';
    async function submit(e) { e.preventDefault(); setBusy(true); setError(''); try {
        const body = mode === 'archive' ? { action: 'archive-database', database: db.id } : { action: 'purge-database', database: db.id, mode, directory: directory || undefined, typedId, acknowledgeDataLoss: acknowledge };
        const endpoint = mode === 'archive' ? '/infra/archive-database-preview' : '/infra/purge-database-preview';
        onReview(body, await api(endpoint, body));
    }
    catch (e) {
        setError(message(e));
    }
    ...
    return React.createElement(Modal, { title: "Gestionar ciclo de vida de base", subtitle: `${db.name} · ${db.id}`, onClose: onClose, wide: true },
        React.createElement("form", { onSubmit: e => void submit(e) },
            React.createElement("fieldset", { className: "lifecycle-options" },
                React.createElement("legend", null, "Acci\u00F3n de ciclo de vida"),
                React.createElement("label", null,
                    React.createElement("input", { type: "radio", name: "database-lifecycle", checked: mode === 'archive', onChange: () => setMode('archive') }),
                    React.createElement("span", null,
                        React.createElement("strong", null, "Archivar base (reversible)"),
                        React.createElement("small", null, "Recomendado. Conserva la base f\u00EDsica, usuario y credencial; retira solo metadata activa."))),
                React.createElement("label", null,
                    React.createElement("input", { type: "radio", name: "database-lifecycle", checked: mode === 'backup-purge', disabled: destructiveUnavailable, onChange: () => setMode('backup-purge') }),
                    React.createElement("span", null,
                        React.createElement("strong", null, "Crear backup y purgar"),
                        React.createElement("small", null, "Exporta y verifica un backup privado antes de eliminar f\u00EDsicamente la base y su cuenta."))),
                React.createElement("label", null,
                    React.createElement("input", { type: "radio", name: "database-lifecycle", checked: mode === 'purge', disabled: destructiveUnavailable, onChange: () => setMode('purge') }),
                    React.createElement("span", null,
                        React.createElement("strong", null, "Purgar sin backup"),
                        React.createElement("small", null, "Irreversible. Solo para datos que confirmas que no necesitas conservar.")))),
            destructiveUnavailable && React.createElement(Alert, null, "Redis comparte el mismo espacio de datos de la instancia y no admite purga por credencial. Puedes archivar la credencial o retirar la instancia completa."),
            mode === 'backup-purge' && React.createElement(Field, { label: "Carpeta de backups (opcional)", help: "Si queda vac\u00EDa se usa la carpeta privada predeterminada de NearProd." },
                React.createElement("input", { value: directory, onChange: e => setDirectory(e.target.value), placeholder: "~/.nearprod/backups/databases" })),
            mode === 'purge' && React.createElement(React.Fragment, null,
                React.createElement(Alert, { error: true },
                    "No habr\u00E1 backup ni rollback. Escribe exactamente ",
                    React.createElement("code", null, db.id),
                    " y confirma la p\u00E9rdida de datos."),
                React.createElement(Field, { label: "ID exacto de la base" },
                    React.createElement("input", { value: typedId, onChange: e => setTypedId(e.target.value), autoComplete: "off" })),
                React.createElement("label", { className: "check-label" },
                    React.createElement("input", { type: "checkbox", checked: acknowledge, onChange: e => setAcknowledge(e.target.checked) }),
                    "Entiendo que la base y su cuenta se eliminar\u00E1n f\u00EDsicamente.")),
            error && React.createElement(Alert, { error: true }, error),
            React.createElement("div", { className: "modal-actions" },
                React.createElement("button", { type: "button", onClick: onClose }, "Cancelar"),
                React.createElement("button", { className: mode === 'archive' ? 'primary' : 'danger', disabled: busy || !ready }, busy ? 'Revisando…' : 'Revisar operación'))));
}
