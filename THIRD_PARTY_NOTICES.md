...
NearProd se distribuye bajo licencia MIT. Los terceros conservan sus licencias.

- Backend/CLI: biblioteca estándar de Go. No hay paquetes de terceros en go.mod. Las releases se compilan con la versión exacta de `.go-version`; la licencia BSD de Go está incluida en internal/webui/dist/vendor/go-LICENSE.txt.
